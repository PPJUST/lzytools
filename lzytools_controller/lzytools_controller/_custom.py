...
def _wait_time_random(min_time: int, max_time: int):
    ...
    return _wait_time(random_time)


"""----------调用函数----------"""


def wait_time(_time: float):
    """等待时间
    :param _time:等待时间
    :return: 等待的时间
    """
    return _wait_time(_time)


def wait_time_random(min_time: int, max_time: int):
    """等待随机时间
    :param min_time: 最小等待时间
    :param max_time: 最大等待时间
    :return: 等待的时间
    """
    return _wait_time_random(min_time, max_time)
